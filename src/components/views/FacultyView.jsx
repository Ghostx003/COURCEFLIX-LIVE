            ...
            <div style={{"padding":"24px","borderBottom":"1px solid var(--border-primary)","display":"flex","alignItems":"center","justifyContent":"space-between","position":"sticky","top":"0","background":"var(--bg-primary)","zIndex":"10"}}>
                <div style={{"display":"flex","alignItems":"center","gap":"12px"}}>
                    <button id="close-faculty-profile-btn" className="primary-btn" style={{"fontSize":"0.9rem","padding":"6px 14px","display":"flex","alignItems":"center","gap":"8px"}}>
                        <i className="fas fa-arrow-left"></i> Back to Faculty Page
                    </button>
                    <button id="go-to-faculty-page-btn" className="primary-btn" style={{"fontSize":"0.9rem","padding":"6px 14px","display":"none","alignItems":"center","gap":"8px","background":"var(--bg-tertiary)","border":"1px solid var(--border-secondary)","color":"var(--text-primary)"}}>
                        <i className="fas fa-chalkboard-teacher"></i> Go to Faculty Page
                    </button>
                </div>
